    ...
    void onPotionButtonPressed(string potionName){
        ...
        switch(potionName){
            ...
            case(PotionHeatStroke.Name):
                ...
                text += "\n\nDescription: " + PotionHeatStroke.Description;
            ...
            case(PotionHypothermia.Name):
                ...
                text += "\n\nDescription: " + PotionHypothermia.Description;
            ...
            case(PotionStabbed.Name):
                ...
                text += "\n\nDescription: " + PotionStabbed.Description;
            ...
            case(PotionSick.Name):
                ...
                text += "\n\nDescription: " + PotionSick.Description;
